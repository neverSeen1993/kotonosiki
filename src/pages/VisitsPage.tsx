...
export default function VisitsPage() {
  ...
  const renderCard = (visit: Visit) => {
    ...
    return (
      <div key={visit.id} className={`card flex items-center gap-2 sm:gap-4 px-3 sm:px-4 py-3 ${
    ...
    <div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        <div className="min-w-0">
          <h1 className="text-xl md:text-2xl font-bold text-gray-800">Графік відвідувань</h1>
